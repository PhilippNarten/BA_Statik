...
class Timoshenkobalken:
    ...
    def Elementsteifigkeitsmatrix(self):  
        ...
        K_el_l = np.array([[self.EA/self.l, 0, 0, -self.EA/self.l, 0, 0],
                           ...
                           [0, -0.5 * self.GA_s, 1/3 * self.GA_s * self.l +self.EI/self.l, 0, 0.5 * self.GA_s, 1/6*self.GA_s*self.l - self.EI/self.l],
                           [-self.EA/self.l, 0, 0, self.EA/self.l, 0 , 0],
                           [0, -self.GA_s/self.l, 0.5*self.GA_s, 0, self.GA_s/self.l, 0.5 * self.GA_s],
                           [0, -0.5 * self.GA_s, 1/6*self.GA_s*self.l - self.EI/self.l, 0, 0.5 * self.GA_s, 1/3 * self.GA_s * self.l +self.EI/self.l ]])
